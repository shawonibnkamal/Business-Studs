...
<div class="vertical-menu">	
  ...
  <li class="nav-item active">
    <a class="nav-link" href="#"><i class="fas fa-briefcase"></i> Territory worked</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
   ...
   <?php  if (isset($_SESSION['email_id'])) : ?>
    <a class="nav-link" href="territory_worked.php?logout='1'"><i class="fas fa-sign-out-alt"></i> Log out</a>
   <?php endif ?>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="block">
        <h3>The Past Projects you have worked on will be displayed here!</h3>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="block">
