...
<div class="vertical-menu">	
  ...
  <li class="nav-item active">
    <a class="nav-link active" href="#"><i class="fas fa-user-alt"></i> Profile</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <a class="nav-link" href="profile_home_sales.php?logout='1'"><i class="fas fa-sign-out-alt"></i> Log out</a>
    <?php endif ?>
		...
		<div>
			<div class="profile-info">
				<p style="text-align: center">
					...
					<span class="badge badge-success">Sales Professional</span>
				</p>
				<p>
					<i class="fas fa-home"></i> Lives in <?php echo $streetAddress.", ".$stateAddress.", ".$country ?> <br>
		...
		<div class="feed">
				...
				<div class="feed-boxes">
					<form>
						...
						<img src="../../<?php echo $databasePicture?>" class="rounded-circle responsive feed-pic"/>
