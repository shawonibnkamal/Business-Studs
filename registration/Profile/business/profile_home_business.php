...
<div class="vertical-menu">	
  ...
  <li class="nav-item active">
    <a class="nav-link active" href="profile_home_business.php"><i class="fas fa-user-alt"></i> Profile</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <a class="nav-link" href="profile_home_business.php?logout='1'"><i class="fas fa-sign-out-alt"></i> Log out</a>
    <?php endif ?>
  </li>
		...
		<div>
			<div class="profile-info">
				...
				<p>
					...
					<span class="badge badge-info" style="margin-left: 25px;">English</span>
				</p>
			</div>
			<div class="profile-info">
				<p>
