	...
	<div class="feed">
				...
				<div class="feed-boxes" style="width: 800px;">
					<form>
						...
						<p style="text-align: right; margin-top: 10px;"><button type="submit" class="btn btn-primary mb-2">Post to Main Feed</button></p>
						</div>
					</form>
				</div>
				<div class="feed-boxes" style="width: 800px;">
					...
					<p>Thank you for joining Business Studs! Main Feed Feature Coming Soon!</p>
