<?php 
  ...
  include('/home3/j6uj8460/servers/settingsServerF.php');
...
<div class="container">
	...
	<div style="width: 900px; border-radius: 25px; background: #18d36e; padding: 20px; margin-bottom: 5px; position: absolute; text-align: center;">
		...
		<form method="post" action="settings.php" enctype="multipart/form-data">
			...
			<input type="text" name="companyName" style="color: white;" value="<?php echo $company_name ?>" placeholder='Firm Name:*' required/>
			...
			<div style="float: right; width: 50%;">
				...
				<input type="text" name="otherlanguages" style="color: white;" value="<?php echo $otherLanguages ?>" placeholder='Other Languages:' />
	       ...
	       <h3 style="margin-top: 10px; color: white; font-size: 1em;"> Change Copy of Work(PDF)*: <input style="margin-left: 105px;" name="copyWork" id="copyWork" type="file" accept=".pdf,.doc" > </h3><br><br>
	      
	 
	       <!-- Code for uploading additional Info -->
	       <h3 style="margin-top: -35px; margin-left:55px; color: white; font-size: 1em;"> Change Additional Information (PDF): <input style="margin-left: 50px;" name="additionalInfo" id="additionalInfo" type="file" accept=".pdf,.doc" > </h3><br>
