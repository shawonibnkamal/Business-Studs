...
<head lang="en">
    ...
    <script type='text/javascript'>
       ...
       //Code for showing profile image after file has been uploaded
...
<body>
  ...
  <div class="user">
    ...
    <form class="form" method="post" action="sales_professional_signups.php" enctype="multipart/form-data">
      ...
      <?php include('errors.php'); ?> 
       ...
       <!-- Code for uploading resume documents -->
       <label> CV/Resume(PDF): <input name="resume" id="resume" type="file" accept=".pdf,.doc" required> </label><br><br>
       
       <label for="profilePicture"> Upload an Appropriate Profile Picture:* </label>
       <p style="color: white;"> Ideal Size: 150px X 150px </p>

 
       <!-- Code for uploading profile picture and previewing image -->
       <input name="profilepic" id="profilepic" style="color: white;" type="file" accept="image/*" onchange="preview_image(event)" required>
       <img id="output_image" style="padding: .5em; max-width: 250px; float; left;" src=""/> <br>
       <br>
       <!-- Code for years of experience options -->
       <select id="experience_years" name="experience" required>
          <optgroup label="Experience" name="experience">

            <option selected hidden value="">Years of Experience*</option>
        ...
        <!-- Code for sales technique options -->
          <label> Select Sales Technique/s:</label><br>
          <label for="one"> <input name="technique[]" type="checkbox" value="Telesales"/> Telesales </label>
          <label for="two"> <input name="technique[]" type="checkbox" value="Door to Door"/> Door to Door </label>
          <label for="three"> <input name="technique[]" type="checkbox" value="Online Demos"/> Online Demos </label>
          <label for="four"> <input name="technique[]" type="checkbox" value="Affiliate Link"/> Affiliate Link </label>
          <label for="five"> <input name="technique[]" type="checkbox" value="Appointment Setting"/> Appointment Setting </label>

        <!-- Code for professional speciality -->
       	<select id="speciality" name="speciality" style="margin-top: 20px; margin-bottom: 20px;" required>
          <optgroup label="Sales Speciality" name="speciality">
            
            <option selected hidden value="">Speciality*</option>
        ...
        <label for="fifteen"> <input type="checkbox" name="language[]" value="dutch"/> Dutch </label>


        <input type='text' name="otherLanguage" placeholder='Other Languages(If Any):'  />
       ...
       <div id="ifLine" style="visibility:hidden">
        <input type='text' id='linefield' name='line' placeholder="Enter Line Information">
       </div>
        ...
        <label for="terms" style="font-size: 0.9em;"> <input name="terms[]" type="checkbox" value="I agree to Terms and Conditions"/> I have read and agreed to the <a href="#" style="color: white;" id="termsCondition">Terms and Conditions</a> </label><br><br><br>
       ...
       <button type="submit" class="btn" name="reg_salesprof_user">Register</button><br>
                

       <br><br>
       <a class="login__link" href="logins_salesprof_page.php">I have already registered. Take me to Log in!</a>
